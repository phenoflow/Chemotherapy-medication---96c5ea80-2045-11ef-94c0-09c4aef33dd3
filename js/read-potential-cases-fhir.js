...
(async () => {
  ...
  await fs.writeFile("chemotherapy-medication-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("chemotherapy-medication-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
