...
codes = [{"code":"34451","system":"prod"},{"code":"40395","system":"prod"},{"code":"34626","system":"prod"},{"code":"34684","system":"prod"},{"code":"40170","system":"prod"},{"code":"34630","system":"prod"},{"code":"34473","system":"prod"},{"code":"34693","system":"prod"},{"code":"34816","system":"prod"}];
REQUIRED_CODES = 1;
